package com.example.service.user.adapter.persistence.user;

import com.example.service.user.infrastructure.adapters.persistence.ReadUserAdapter;
import com.example.service.user.infrastructure.adapters.persistence.UserJpaMapper;
...
import static com.example.service.user.domain.user.UserFunctions.userFirstName;
import static com.example.service.user.domain.user.UserFunctions.userIdAsInt;
import static com.example.service.user.domain.user.UserFunctions.userLastName;
